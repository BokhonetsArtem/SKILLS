...
Не добавляй MUI / Ant / Chakra / Mantine в репо, где их нет. В YEAHUB свой `shared/ui`, не Ant/MUI: этот файл там не применяется, пока пользователь явно не просил кит.
...
| Не надо | Надо |
| --- | --- |
| Добавить MUI/Ant в YEAHUB | `shared/ui` проекта |
