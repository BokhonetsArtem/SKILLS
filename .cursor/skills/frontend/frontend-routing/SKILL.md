...
- «нужен ли SSR / проверь гидрацию / server-client boundary / переведи на SSR» → [`frontend-ssr`](../frontend-ssr/SKILL.md)
...
| Нужен ли SSR/RSC/island, hydration mismatch, точечная миграция границы | [`frontend-ssr`](../frontend-ssr/SKILL.md) — не этот скил |
...
- Нужен ли SSR / гидрация / server-client граница → это [`frontend-ssr`](../frontend-ssr/SKILL.md), не этот скил.
